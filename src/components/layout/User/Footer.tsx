    ...
    <footer className="bg-white pb-4 pt-12">
      <div className="container mx-auto px-4 max-w-[1228px]">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8">
          <div>
            ...
            <div className="pb-3">
              <div className="flex items-center pb-2">
                <div
                  className="w-[40px] h-[32px] flex items-center justify-center overflow-hidden"
                  style={{
            ...
            <div className="flex space-x-4">
              <a href="#" className="hover:text-blue-500 text-gray-600">
                <FaFacebookF size={24} />
              </a>
              <a href="#" className="hover:text-blue-500 text-gray-600">
                <FaTwitter size={24} />
          ...
          {/* About Us Section */}
          <div>
            <h3 className="text-xl mb-4">ACP</h3>
            <ul>
              <li>
                <a href="#" className="hover:text-blue-500 text-gray-600">
                  Về chúng tôi
          ...
          {/* Support Section */}
          <div>
            <h3 className="text-xl mb-4">Chính sách chung </h3>
            <ul>
              <li>
                <a href="#" className="hover:text-blue-500 text-gray-600">
                  Hướng dẫn sử dụng
        ...
        <div>
          <h3 className="text-lg mb-3">Thông tin doanh nghiệp</h3>
          <ul>
