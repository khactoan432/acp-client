...
export const fetchAdminTeachers = createAsyncThunk('teachers/fetchAdminTeachers', async ({ role, page, limit }, { rejectWithValue }) => {
    try {
...
export const fetchUserTeachers = createAsyncThunk('teachers/fetchUserTeachers', async ({ role, page, limit }, { rejectWithValue }) => {
    try {
...
export const createTeacher = createAsyncThunk('teachers/createTeacher', async (userData, { rejectWithValue }) => {
    try {
...
export const updateTeacher = createAsyncThunk('teachers/updateTeacher', async ({ userId, updatedData }, { rejectWithValue }) => {
    try {
...
export const deleteTeacher = createAsyncThunk('teachers/deleteTeacher', async (userId, { rejectWithValue }) => {
    try {
