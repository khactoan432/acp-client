...
export const fetchAdminOrders = createAsyncThunk('orders/fetchAdminOrders', async ({ page, limit }, { rejectWithValue }) => {
    try {
...
export const fetchUserOrders = createAsyncThunk('orders/fetchUserOrders', async ({ page, limit }, { rejectWithValue }) => {
    try {
...
//   }
// );
export const updateOrder = createAsyncThunk('orders/updateOrder', async ({ orderId, updatedData }, { rejectWithValue }) => {
    try {
