...
export const fetchAdminCategories = createAsyncThunk('categories/fetchAdminCategories', async ({ page, limit }, { rejectWithValue }) => {
    try {
...
export const fetchUserCategories = createAsyncThunk('categories/fetchUserCategories', async (_, { rejectWithValue }) => {
    try {
...
export const updateCategory = createAsyncThunk('categories/updateCategory', async ({ categoryId, updatedData }, { rejectWithValue }) => {
    try {
