...
const AdminTeacher = () => {
    ...
    const funcCreate = async (data) => {
        setIsLoading(true);
        const { name, email, password, repassword, codeforce_name, phone_number, image, } = data;
    ...
    const funcDelete = async () => {
        ...
        try {
            ...
            const results = await Promise.allSettled(listIdDeleted.map((element) => deleteData(`/api/admin/user/${element}`, {
                headers: {
                    Authorization: `Bearer ${header}`,
                },
            })));
    ...
    return (_jsxs("div", { className: "flex h-screen", children: [_jsx(Nav, {}), _jsxs("div", { className: "flex flex-col flex-1", children: [_jsx(AdminHeader, {}), _jsxs("div", { className: "w-full h-full bg-white", children: [_jsxs("div", { style: { height: `calc(100% - 8px)` }, className: "m-2", children: [_jsxs("div", { ref: secondDivRef, className: "header_categories flex justify-between items-center bg-primary px-5 py-3 mb-2", children: [_jsx("div", { className: "left uppercase", children: _jsx("h2", { className: "font-size-20", children: "Danh s\u00E1ch gi\u00E1o vi\u00EAn" }) }), _jsx("div", { className: "right uppercase", children: _jsx(Button, { className: "button-save box-shadow-btn-save", style: {
                                ...
                                }, structData: structData, onSave: funcCreate, title: "T\u1EA1o m\u1EDBi gi\u00E1o vi\u00EAn" })), isModalUpdate && (_jsx(AdminModalV2, { action: "UPDATE", isOpen: isModalUpdate, onClose: () => {
                                    setIsModalUpdate(false);
                                    setSelectedContent(null);
                                }, structData: structData, onSave: funcUpdate, title: "C\u1EADp nh\u1EADt gi\u00E1o vi\u00EAn" })), isModalVisible && (_jsx(PopupNotification, { title: Array.isArray(idTeacher)
