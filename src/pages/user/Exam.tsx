        ...
        <div className="flex pt-14">
          <div className="w-full max-w-[20%] lg:w-1/3 px-4 rounded-lg sticky top-[80px] h-max">
            ...
            <div>
              ...
              <div>
                <h4 className="font-size-16 text-sm font-medium mb-2">
                  Theo khu vực
                </h4>
                <ul className="space-y-2 text-sm text-gray-700">
                  <li>
...
const exams = [
  {
    ...
    discount: 2888,
    tags: [
      { type: "Danh mục", value: "Đề Chuyên tin học THPT" },
  ...
  },
  {
    ...
    discount: 5941,
    tags: [
      { type: "Danh mục", value: "Đề Olympic tin học" },
  ...
  },
  {
    ...
    discount: 9155,
    tags: [
      { type: "Danh mục", value: "Đề Tài năng tin học trẻ" },
      { type: "Theo độ khó", value: "Đề luyện tập" },
